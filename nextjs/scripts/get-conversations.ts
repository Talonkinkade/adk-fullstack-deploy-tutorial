 ...
 *
 * Usage:
 * 1. From the nextjs directory:
 *    USER_ID="your-user-id" npm run get-conversations
 *    OR
 *    USER_ID="your-user-id" npx tsx scripts/get-conversations.ts
 */

import { listUserSessions } from '../src/lib/session-history';
